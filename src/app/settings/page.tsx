            ...
            <form onSubmit={handleSaveProfile} className="space-y-6">
              ...
              <div>
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3">
                    <Link2 className="w-4 h-4 text-text3 flex-shrink-0" />
          ...
          {activeTab === "account" && (
            <div className="space-y-8">
              ...
              <div className="pt-6 border-t border-red-500/20">
                ...
                <button className="px-4 py-2 bg-red-500/10 border border-red-500/30 text-red-500 font-mono text-xs uppercase tracking-wider hover:bg-red-500 hover:text-white transition-all">
                  Delete Account
                </button>
              </div>
            </div>
